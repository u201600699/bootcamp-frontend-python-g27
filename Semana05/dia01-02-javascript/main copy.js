...
console.log(invitados); //['Ana', 'Luis', 'María', 'Pedro', 'Carla']
...
console.log("El número mayor es:", mayor); // 99
...
let pares = 0;
 let impares = 0;  
    ...
    console.log("Cantidad de números pares:", pares); // 3
    console.log("Cantidad de números impares:", impares); // 2
...
console.log("Arreglo invertido:", inverso); // [5, 4, 3, 2, 1]
...
invitados = ["Ana", "Luis", "María", "Pedro", "Carla"];
let nombreBuscado = "María";
let encontrado = false;
for (let i = 0; i < invitados.length; i++) {
    if (invitados[i] === nombreBuscado) {
        console.log(nombreBuscado + " está en la lista en el índice " + i);
        encontrado = true;
        break;
    }
}
...
const sumatoria = numeros1.reduce(
...
console.log('Precio  las frutas', preciosFrutas)

// 3. filter → frutas con stock disponible
const stockdefrutas = frutas.filter(function(stock){
    return stock.cantidad > 0
})
console.log('frutas en stock', stockdefrutas)
